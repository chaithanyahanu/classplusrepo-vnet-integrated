...
subscription_id = "69ad85a8-e5ae-40f5-8f70-f01c051c3d27"
}
  ...
  "resources": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "virtualNetworkRules": [
          {
            "id": "/subscriptions/${data.azurerm_client_config.example.subscription_id}/resourceGroups/${data.azurerm_resource_group.existing.name}/providers/Microsoft.Network/virtualNetworks/${data.azurerm_virtual_network.existing_vnet.name}/subnets/${data.azurerm_subnet.existing_subnet.name}"
          }
        ]
      }
    }
